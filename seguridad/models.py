...
class Sucursal(models.Model):
    ...
    pais = models.ForeignKey(Pais, verbose_name="País", db_column="suc_pais", null=True, blank=True, on_delete=models.PROTECT)
    region = models.ForeignKey(Region, verbose_name="Región", db_column="suc_region", null=True, blank=True, on_delete=models.PROTECT)
    comuna = models.ForeignKey(Comuna, verbose_name="Comuna", db_column="suc_comuna", null=True, blank=True, on_delete=models.PROTECT)
...
class Usuario(models.Model):
    ...
    usu_id = models.AutoField("Key", primary_key=True)
    ...
    pais = models.ForeignKey(Pais, verbose_name="País", db_column="usu_pais", null=True, blank=True, default=None, on_delete=models.PROTECT)  #
    region = models.ForeignKey(Region, verbose_name="Región", db_column="usu_region", null=True, blank=True, on_delete=models.PROTECT)  #
    comuna = models.ForeignKey(Comuna, verbose_name="Comuna", db_column="usu_comuna", null=True, blank=True, on_delete=models.PROTECT)  #
...
class UsuarioEmpresa(models.Model):
    ...
    cargo = models.ForeignKey(Cargo, verbose_name="Cargo", db_column="ue_cargo", null=True, blank=True, on_delete=models.PROTECT)
    ...
    # AFP
    # -----------------------------
    afp = models.ForeignKey(Afp, verbose_name="AFP", db_column="ue_afp", null=True, blank=True, on_delete=models.PROTECT)
    ...
    # SALUD
    # -----------------------------
    salud = models.ForeignKey(Salud, verbose_name="Salud", db_column="ue_salud", null=True, blank=True, on_delete=models.PROTECT)
    ...
    banco = models.ForeignKey(Bancos, verbose_name="Banco", db_column="ue_banco", null=True, blank=True, on_delete=models.PROTECT)
...
class RelacionDeAfiliacion(models.Model):
    ...
    empresa = models.ForeignKey(Empresa, verbose_name="Empresa", db_column="rda_empresa", on_delete=models.PROTECT)
    cajascompensacion = models.ForeignKey(CajasCompensacion, verbose_name="Cajas Compensacion",
                                          db_column="rda_cajacompemsacion", null=True, blank=True, on_delete=models.PROTECT)
